    ...
    <md-card>
      ...
      <form id="form" novalidate @submit.prevent>
        ...
        <md-field>
          ...
          <md-input type="text" name="title" id="title" v-model="file.metadata[file.metadata.length - 1].title"></md-input>
        ...
        <md-button type="submit" class="md-raised md-primary" @click="validateUser()">Edit</md-button>
      </form>
    </md-card>
  </div>
</template>
